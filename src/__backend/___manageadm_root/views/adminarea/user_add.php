                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" id="text-input" name="nama" class="form-control" placeholder="Name">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                ...
                                <div class="card-footer">
                                    <button type="submit" name="action" value="new" class="btn btn-sm btn-primary"><i class="fa fa-dot-circle-o"></i> Add User</button>
